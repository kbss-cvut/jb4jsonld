...
@JsonLdType(iri = Vocabulary.PERSON_LD)
public class PersonLdType implements GeneratesRdf {
    ...
    public static Field getFirstNameField() throws NoSuchFieldException {
        return PersonLdType.class.getDeclaredField("firstName");
    }

    public static Field getLastNameField() throws NoSuchFieldException {
        return PersonLdType.class.getDeclaredField("lastName");
    }
}
