...
@JsonLdType(iri = Vocabulary.USER_LD)
public class UserLdType extends Person {
    ...
    public UserLdType(URI uri, String firstName, String lastName, String username, Boolean admin) {
        this.setUri(uri);
    ...
    public static Field getUsernameField() throws NoSuchFieldException {
        return UserLdType.class.getDeclaredField("username");
    }
}
