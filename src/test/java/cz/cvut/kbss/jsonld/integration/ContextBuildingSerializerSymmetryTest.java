...
public class ContextBuildingSerializerSymmetryTest extends DeSerializationSymmetryTest {

    @Override
    JsonLdSerializer getSerializer(BufferedJsonGenerator jsonWriter, Configuration configuration) {
        return JsonLdSerializer.createContextBuildingJsonLdSerializer(jsonWriter, configuration);
    }
}
