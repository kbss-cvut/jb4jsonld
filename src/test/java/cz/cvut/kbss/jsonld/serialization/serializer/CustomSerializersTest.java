...
class CustomSerializersTest {
    ...
    void visitAttributeUsesConfiguredCustomSerializerWhenTypeMatches() throws Exception {
        ...
        final SerializationContext<Integer> ctx = new SerializationContext<>(Vocabulary.NUMBER_OF_PEOPLE_INVOLVED, Study.class.getDeclaredField("noOfPeopleInvolved"), study.getNoOfPeopleInvolved(), DummyJsonLdContext.INSTANCE);
